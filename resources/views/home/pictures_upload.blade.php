    ...
    <div class="rw-main-container">
        ...
        <div class="rw-right-panel">
            ...
            <div class="rw-container" id="frame"><!-- use .rw-container instead of .container on private_template -->
                ...
                <br/>
                <br/>
                <form name="povprasevanje" method="POST" action="{{ route('pictures.upload.post') }}" role="form" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label" for="name">Opis slike</label>
                                <input type="text" class="input" id="opis" name="opis" placeholder="Pica s/z ..." required/>
                                @if ($errors->has('opis'))
                    ...
                    <div class="row form-buttons">
                        <div class="col-md-6">
                            <button class="btn btn-lg btn-primary">Naloži</button>
                        </div>
                    </div>
                </form>
