...
@section('content')
    ...
    <div class="rw-main-container">
        ...
        <div class="rw-right-panel">
            ...
            <div class="rw-container" id="frame"><!-- use .rw-container instead of .container on private_template -->
                ...
                <header>
                    ...
                    <div class="buttons pull-right">
                        <h1><a class="icon" title="Naloži"><span class="glyphicon glyphicon-upload"></span></a></h1>
            ...
            <!--<rwt-footer class="ng-isolate-scope"><div class="text-center">
                            <div class="btn-group pagination">
                                <button class="btn btn-default btn-lg" ng-click="goToPage(1)">First</button>

                                <button class="btn btn-default btn-lg" ng-click="goToPage(currentPage - 1)">&lt;</button>

                                <div class="btn btn-default btn-lg">
                                    <input type="text" class="select-page ng-pristine ng-valid ng-touched" ng-model="selectPage" ng-change="goToPage(selectPage)">
                                    of <span class="ng-binding">2</span>
                                </div>

                                <button class="btn btn-default btn-lg" ng-click="goToPage(currentPage + 1)">&gt;</button>
                                <button class="btn btn-default btn-lg" ng-click="goToPage(totalPages)">Last</button>
                            </div>
