        ...
        <div class="rw-left-panel hidden-print">
                ...
                <div class="navbar-collapse collapse navbar-collapse-main">
                    ...
                    <div class="rw-panel">
                        ...
                        <ul class="nav nav-stacked rw-front card active">
                            <li data-active="user-dashboard" class='active'>
                                <a href="#"><span class="glyphicon glyphicon-home"></span>Dashboard</a>
                            </li>
                            <li data-active="user-statistics">
                                <a href="#"><span class="glyphicon glyphicon-signal"></span>Statistika</a>
                            </li>
                            <li data-active="user-statistics">
                                <a href="#"><span class="glyphicon glyphicon-phone"></span>Mobilna aplikacija</a>
                            </li>
                            <li data-active="user-statistics">
                                <a href="#"><span class="glyphicon glyphicon-picture"></span>Slike</a>
                            </li>
                            <li data-active="user-statistics">
                                <a href="#"><span class="glyphicon glyphicon-envelope"></span>Sporočila</a>
                            </li>
                            <li data-active="user-statistics">
                                <a href="#"><span class="glyphicon glyphicon-folder-open"></span>FB Objave</a>
                            </li>
                            <li data-active="user-withdrawal">
            ...
            <div class="footer hidden-xs"><!-- This is hidden on small devices -->
                ...
                <div class="rw-footer-navigation">
                    <ul>
                        <li class="settings"><a data-toggle="tooltip" data-placement="top" title="Settings" id="settings-nav-trigger"><span class="glyphicon glyphicon-cog"></span>Settings</a></li>
